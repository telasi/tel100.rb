...
RSpec.describe 'Signee, Author' do
  ...
  specify{ expect(@u1.received?).to eq(false) }
  specify{ expect(@u2.received?).to eq(true) }
  specify{ expect(@u3.received?).to eq(false) }
  ...
  context 'signee signs' do
    ...
    specify{ expect(@u1.received?).to eq(false) }
    specify{ expect(@u2.received?).to eq(false) }
    specify{ expect(@u3.received?).to eq(true) }
 end
