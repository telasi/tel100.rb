...
module Folders
  ...
  STANDARD << Folder::Standard.new(4,1,'<i class="fa fa-envelope-o"></i>','ხელმოსაწერი', 'На подпись', 'For sign', Folder::Standard::INBOX_SIGNEE)
  ...
  STANDARD << Folder::Standard.new(6,nil,'<i class="fa fa-envelope-o"></i>','დავიზირებული', 'Подписанные', 'Signed', Folder::Standard::INBOX_SIGNED)
