...
module Folders
  ...
  STANDARD << Folder::Standard.new(4,1,'<i class="fa fa-envelope-o"></i>','დასავიზირებელი', 'Ожидающие визирования', 'For confirmation', Folder::Standard::INBOX_SIGNEE)
  STANDARD << Folder::Standard.new(5,1,'<i class="fa fa-envelope-o"></i>','ხელმოსაწერი', 'На подпись', 'For sign', Folder::Standard::INBOX_AUTHOR)
  STANDARD << Folder::Standard.new(6,1,'<i class="fa fa-external-link"></i>','გადაგზავნილი', 'Пересланные', 'Resent', Folder::Standard::INBOX_RESENT)
