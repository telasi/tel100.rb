Ext.define('Tel100.view.document.motions.SigneeModifyPanel', {
  extend: 'Ext.panel.Panel',
  alias: 'widget.documentmotionssigneemodifypanel',

  controller: 'documentmotionssigneemodifypanel',
  viewModel: {
    type: 'documentmotionssigneemodifypanel'
  },
  layout: 'fit',
    ...
    if(record.get('status') != helpers.document.status.COMPLETED && record.get('status') != helpers.document.status.CANCELED ){
      var gridMenu = Ext.create('Ext.menu.Menu', {
        items: [{
          ...
          handler: function() {
            var view = dataview.up('documentmotionssigneemodifypanel');
