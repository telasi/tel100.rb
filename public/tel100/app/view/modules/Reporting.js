...
Ext.define('Tel100.view.modules.ReportingViewController', {
  ...
  onItemDoubleClick: function(v, record, item, index, e){
    ...
    if (operation != null) {
      var url = '<iframe src="192.168.1.32:3000/reporting/' + record.get('operation') + '" style="width:100%;height:100%;" id="reporting"></iframe>';
      ...
      dynamicPanel = new Ext.Component({                    
                    autoEl: {
                        ...
                        src: 'http://192.168.1.32:3000/reporting/' + record.get('operation') + '?lang=' + helpers.i18n.getCurrentLocale() + '&user=' + user.id
                    },
                    height: 600,
                    id: 'reporting_iframe',
                    width: 600
